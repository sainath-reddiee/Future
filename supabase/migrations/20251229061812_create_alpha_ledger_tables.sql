...
-- Creates all necessary tables for the financial trading application
...
CREATE POLICY "trades_policy" ON trades FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "signals_policy" ON signals FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "portfolio_policy" ON portfolio FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "market_data_policy" ON market_data FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "api_cache_policy" ON api_cache FOR ALL USING (true) WITH CHECK (true);
